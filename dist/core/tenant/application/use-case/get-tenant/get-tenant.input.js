...
_export(exports, {
    GetTenantInput: function() {
        return GetTenantInput;
    },
...
let GetTenantInput = class GetTenantInput {
    constructor(props){
        if (!props) return;
        this.id = props.id;
    }
...
], GetTenantInput.prototype, "id", void 0);
...
//# sourceMappingURL=get-tenant.input.js.map